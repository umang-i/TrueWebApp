...
class ReferRetailerViewController: UIViewController, CustomNavBarDelegate {
    ...
    func setupUI() {
        ...
        sendReferralButton.backgroundColor = .systemRed
        sendReferralButton.titleLabel?.font = UIFont(name: "Roboto-Bold", size: 16)
        ...
        NSLayoutConstraint.activate([
            ...
            sendReferralButton.heightAnchor.constraint(equalToConstant: 50),
